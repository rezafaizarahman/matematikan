...
var game = function(){
  ...
  this.play = function(){
    ...
    $(this.background1);
    //background1 move _px per cycle
    updateBackground($(this.background1), -1, 0);
    //background2 move 1px per cycle
    updateBackground($(this.background2), -2, 0);
...
var missile = function(type){
  ...
  this.pos = {
    ...
    top: $(player1.player).offset().top + 38,
    left: $(player1.player).offset().left + 103
  };
